...
const int SMS_COMMON      = 8;
const int SMS_BERY_COMMON = 16; // WEIGHTED CHANCE
...
void SMS_UpdateStoneID(object oPC, object oItem) {
   ...
   if (!nStoneID) return;
   string sSQL = "update stonetracker set st_plid=" + GetLocalString(oPC, "SDB_PLID") + " where st_stid="+IntToString(nStoneID);
   SQLExecDirect(sSQL);
}
...
int SMS_GetNextStoneID(object oCreateOn, string sName) {
   ...
   string sSQL = "insert into stonetracker (st_name, st_plid) values ("+ DelimList(InQs(sName), sPLID) + ")";
   SQLExecDirect(sSQL);
...
string SMS_PickStone() {
   ...
   for (nPass=0; nPass<=1; nPass++) {
      ...
      if      (SMS_PickByWeight(nPass, nRoll, SMS_BERY_COMMON)) sTag = "SMS_AC";
      else if (SMS_PickByWeight(nPass, nRoll, SMS_BERY_COMMON)) sTag = "SMS_ATTACK";
      else if (SMS_PickByWeight(nPass, nRoll, SMS_BERY_COMMON)) sTag = "SMS_DAM_ACID";
      else if (SMS_PickByWeight(nPass, nRoll, SMS_BERY_COMMON)) sTag = "SMS_DAM_COLD";
      ...
      else if (SMS_PickByWeight(nPass, nRoll, SMS_BERY_COMMON)) sTag = "SMS_SK_CONCENTRATION";
      else if (SMS_PickByWeight(nPass, nRoll, SMS_BERY_COMMON)) sTag = "SMS_SK_LISTEN";
      else if (SMS_PickByWeight(nPass, nRoll, SMS_BERY_COMMON)) sTag = "SMS_SK_SPELLCRAFT";
      else if (SMS_PickByWeight(nPass, nRoll, SMS_BERY_COMMON)) sTag = "SMS_SK_SPOT";
      else if (SMS_PickByWeight(nPass, nRoll, SMS_BERY_COMMON)) sTag = "SMS_REGEN";
      else if (SMS_PickByWeight(nPass, nRoll, SMS_BERY_COMMON)) sTag = "SMS_CAST_" + IntToString(SMS_PickCastType(SMS_BERY_COMMON));
      ...
      else if (SMS_PickByWeight(nPass, nRoll, SMS_COMMON     )) sTag = "SMS_SK_INTIMIDATE";
      else if (SMS_PickByWeight(nPass, nRoll, SMS_COMMON     )) sTag = "SMS_SK_TAUNT";
      else if (SMS_PickByWeight(nPass, nRoll, SMS_COMMON     )) sTag = "SMS_SAVE_FEAR";
      else if (SMS_PickByWeight(nPass, nRoll, SMS_COMMON     )) sTag = "SMS_SAVE_MIND";
      else if (SMS_PickByWeight(nPass, nRoll, SMS_COMMON     )) sTag = "SMS_CAST_" + IntToString(SMS_PickCastType(SMS_COMMON));

      else if (SMS_PickByWeight(nPass, nRoll, SMS_RARE       )) sTag = "SMS_DAM_NEGATIVE";
      else if (SMS_PickByWeight(nPass, nRoll, SMS_RARE       )) sTag = "SMS_DAM_POSITIVE";
      ...
      else if (SMS_PickByWeight(nPass, nRoll, SMS_RARE       )) sTag = "SMS_SK_DISCIPLINE";
      else if (SMS_PickByWeight(nPass, nRoll, SMS_RARE       )) sTag = "SMS_SK_UMD";
      else if (SMS_PickByWeight(nPass, nRoll, SMS_RARE       )) sTag = "SMS_SK_PERFORM";
      else if (SMS_PickByWeight(nPass, nRoll, SMS_RARE       )) sTag = "SMS_SAVE_DEATH";
      else if (SMS_PickByWeight(nPass, nRoll, SMS_RARE       )) sTag = "SMS_CAST_" + IntToString(SMS_PickCastType(SMS_RARE));
      ...
      else if (SMS_PickByWeight(nPass, nRoll, SMS_VERY_RARE  )) sTag = "SMS_OH_STUN";
      else if (SMS_PickByWeight(nPass, nRoll, SMS_VERY_RARE  )) sTag = "SMS_OH_HOLD";
      else if (SMS_PickByWeight(nPass, nRoll, SMS_VERY_RARE  )) sTag = "SMS_SAVE_FORTITUDE";
      else if (SMS_PickByWeight(nPass, nRoll, SMS_VERY_RARE  )) sTag = "SMS_SAVE_REFLEX";
      else if (SMS_PickByWeight(nPass, nRoll, SMS_VERY_RARE  )) sTag = "SMS_SAVE_WILL";
      else if (SMS_PickByWeight(nPass, nRoll, SMS_VERY_RARE  )) sTag = "SMS_SPELLRESIST";
      else if (SMS_PickByWeight(nPass, nRoll, SMS_VERY_RARE  )) sTag = "SMS_CAST_" + IntToString(SMS_PickCastType(SMS_VERY_RARE));
   }
   return sTag;
}
