...
// * TREASURE AMOUTNS
int TREASURE_LOW = 1;       int TREASURE_MEDIUM = 2;    int TREASURE_HIGH = 3;       int TREASURE_BOSS = 4;
...
void SRM_CreateGem(object oTarget, int nTreasureType, int nHD = 1) {
   ...
   if (iGold > 30000 && Random(1000)==1) {
      string sIon = PickOne("x2_is_sandblue", "x2_is_blue", "x2_is_deepred", "x2_is_drose", "x2_is_paleblue", "x2_is_pink", "x2_is_pandgreen");
      CreateItemOnObject(sIon, oTarget);
      iGold = iGold - 30000;
   }
