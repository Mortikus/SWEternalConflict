...
void WTSLE(string sText) {
   //return; // REMOVE THIS LINE TO GET DEBUGGER OUTPUT
...
void Compensate(object oPC) {
   ...
   if (iOldGP > 0) { // SECOND RUN, GIVE DIFFERENCE
      ...
      SendMessageToPC(oPC, GetRGB(11,9,11) + "Success! Your items were forced into compliance with the item rules and you were compensated for any loses. Read your journal for more information.");
